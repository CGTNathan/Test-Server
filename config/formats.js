...
exports.Formats = [
	...
	},
	{
		...
		ruleset: ['Pokemon', 'Standard', 'Team Preview', 'Swagger Clause', 'Baton Pass Clause'],
		banlist: ['Uber', 'Illegal', 'Unreleased', 'Caterpie', 'Weedle', 'Farfetch’d', 'Tauros', 'Magikarp', 'Pinsir', 'Aerodactyl', 'Articuno', 'Zapdos', 'Moltres', 'Mewtwo', 'Mew', 'Igglybuff', 'Sunkern', 'Unown', 'Dunsparce', 'Qwilfish', 'Shuckle', 'Heracross', 'Corsola', 'Delibird', 'Stantler', 'Smeargle', 'Miltank', 'Raikou', 'Entei', 'Suicune', 'Lugia', 'Ho-Oh', 'Celebi', 'Wurmple', 'Slakoth', 'Nincada', 'Sableye', 'Mawile', 'Plusle', 'Minun', 'Volbeat', 'Illumise', 'Torkoal', 'Spinda', 'Zangoose', 'Seviper', 'Lunatone', 'Solrock', 'Feebas', 'Castform', 'Kecleon', 'Tropius', 'Absol', 'Relicanth', 'Luvdisc', 'Regirock', 'Regice', 'Registeel', 'Latias', 'Latios', 'Kyogre', 'Groudon', 'Rayquaza', 'Jirachi', 'Deoxys', 'Kricketot', 'Burmy', 'Combee', 'Pachirisu', 'Carnivine', 'Rotom', 'Uxie', 'Mesprit', 'Azelf', 'Dialga', 'Palkia', 'Heatran', 'Regigigas', 'Giratina', 'Cresselia', 'Phione', 'Manaphy', 'Darkrai', 'Shaymin', 'Arceus', 'Victini', 'Audino', 'Throh', 'Sawk', 'Basculin', 'Maractus', 'Sigilyph', 'Emolga', 'Alomomola', 'Tynamo', 'Stunfisk', 'Druddigon', 'Bouffalant', 'Heatmor', 'Durant', 'Cobalion', 'Terrakion', 'Virizion', 'Tornadus', 'Thundurus', 'Reshiram', 'Zekrom', 'Landorus', 'Kyurem', 'Keldeo', 'Meloetta', 'Genesect', 'Scatterbug', 'Furfrou', 'Hawlucha', 'Dedenne', 'Carbink', 'Klefki', 'Xerneas', 'Yveltal', 'Zygarde', 'Kangaskhan', 'Lapras', 'Ditto', 'Girafarig', 'Skarmory', 'Chatot', 'Cryogonal', 'Torchic', 'Combusken', 'Honedge', 'Doublade', 'Froakie', 'Frogadier', 'Slowbronite', 'Salamencite', 'Gengarite', 'Lucarionite']
	},
	{
		name: "StAAAbmons",
		section: "Other Metagames",

		ruleset: ['Pokemon', 'Team Preview', 'Ability Clause', 'Mega Rayquaza Clause', 'Swagger Clause', 'Baton Pass Clause', 'Endless Battle Clause', 'Sleep Clause Mod', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Moody Clause', 'Evasion Moves Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod'],
		banlist: ['Illegal', 'Ignore Illegal Abilities', 'Ignore STAB Moves', 'Adaptability', 'Aerilate', 'Arena Trap', 'Contrary', 'Delta Stream', 'Fur Coat', 'Huge Power', 'Imposter', 'Parental Bond', 'Protean', 'Pure Power', 'Shadow Tag', 'Simple', 'Speed Boost', 'Wonder Guard', 'Chatter', 'Sylveon', 'Porygon-Z', 'Keldeo', 'Diggersby', 'Archeops', 'Kyurem-Black', 'Regigigas', 'Shedinja', 'Slaking', 'Smeargle', 'Bisharp', 'Terrakion', 'Mamoswine', 'Arceus', 'Blaziken', 'Darkrai', 'Deoxys', 'Deoxys-Attack', 'Dialga', 'Genesect', 'Giratina', 'Giratina-Origin', 'Groudon', 'Kyogre', 'Kyurem-White', 'Landorus', 'Lugia', 'Meloetta', 'Mewtwo', 'Palkia', 'Rayquaza', 'Reshiram', 'Shaymin-Sky', 'Xerneas', 'Yveltal', 'Zekrom', 'Soul Dew', 'Aerodactylite', 'Gengarite', 'Kangaskhanite', 'Lucarionite', 'Mawilite', 'Salamencite', 'Altarianite', 'Metagrossite', 'Lopunnite', 'Slowbronite']
	},
	{
		name: "CAP",
		section: "Other Metagames",
